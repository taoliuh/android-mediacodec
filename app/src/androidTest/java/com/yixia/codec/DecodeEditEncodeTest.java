...
public class DecodeEditEncodeTest extends AndroidTestCase {
     ...
     */
    private void videoEditTest() throws IOException {
     ...
     */
    private boolean generateVideoFile(VideoChunks output) throws IOException {
     ...
     */
    private VideoChunks editVideoFile(VideoChunks inputData) throws IOException {
     ...
     */
    private void checkVideoFile(VideoChunks inputData) throws IOException {
